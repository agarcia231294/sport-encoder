<div class="item-session">
    ...
    <div class="data"><span class="label">@lang('Max. Acceleration'):</span> {{ $session->max_acceleration }} m/s<sup>2</sup></div>
    <div class="data"><span class="label">@lang('Avg. Acceleration'):</span> {{ $session->avg_acceleration }} m/s<sup>2</sup></div>
    ...
    <div class="actions">
        <a class="btn" href="{{ route('dashboard.session.generateStadistics', ['id'=>$session->id, 'kg'=> -1]) }}" onclick="setKG()">@lang('Calculate statistics')</a>
